...
《FDE · AI 竞赛不在于模型》这本书,不讲空泛的"AI 概念",只讲"AI 项目从 PoC 推到生产"的真实战场。全书 26 章,26 个一线项目故事 + 7 个行业反挫案例(医疗/金融/制造/政务/教育/法律)+ 1 套 FDE 能力清单。

读这本书,你不会得到"哪个模型最好"的答案;你会得到"模型选完后,如何把它真正跑起来"的方法论。

## 短版(微博/抖音,60 字)

26 个一线项目故事,告诉你 AI 项目的真正死法 + 1 套"从 PoC 推到生产"的方法论。多数 AI 项目的死法,都是同一类。

## 英文版(海外版,约 150 字)

Most AI books focus on the model. *FDE · AI Projects Win on Deployment, Not Models* focuses on what happens after the model is chosen. It does not teach AI concepts; it teaches the practitioner how to take an AI project from a polished PoC to a production system that actually works.
