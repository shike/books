"""
v7 变体: 基于 wb-v7-base.png (2400x1600) 真实 WorkBuddy v5.3.12
...
def make_variant(name, user_msg=None, ai_blocks=None, think_text=None, artifact=None, task_title=None):
    ...
    # 1. 顶部 - 如果有 task_title,改"本地助理"为任务标题
    if task_title:
        draw.rectangle([(540, 0), (2400, 130)], fill=COLOR_BG)
        # 重画"本地助理" + 任务标题
        # 实际上保留"本地助理 已连接:微信小程序"标题
...
print(f"  1.9-main-interface.png  (复制自 v7-base)")
