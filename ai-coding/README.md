...
| 主书 DOCX | ✅ | `dist/main.docx` | 平台分发、阅读、注释 |
| 主书 EPUB | ✅ | `dist/ai-coding.epub` | KDP/Apple/微信读书/豆瓣 上架 |
...
| 营销文案(blurb/长描述/作者介绍 等) | ✅ | `promotion/` | 上架、自媒体传播 |
| 配套数字仓库(16 提示词 + 11 案例 + 4 速查表) | ✅ | `assets/` | 独立发布的二级产品 |
| 12 篇研究资料 | ✅ | `assets/research/` | 写作底稿,二次创作可引 |
| 上架与版本管理(CHANGELOG + feedback) | ✅ | `promotion/CHANGELOG.md` + `feedback.md` | 版本可追溯、读者可反馈 |
...
### 二次分发 / 上架
- 平台上传 → `dist/main.docx` / `dist/main.pdf` / `dist/ai-coding.epub`
- 自行排版 → 用 `chapters/00-chapter.md` ~ `15-chapter.md` 在 InDesign/Word 里合成(若需纸质)
